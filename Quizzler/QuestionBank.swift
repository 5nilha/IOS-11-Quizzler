...
class QuestionBank {
    ...
    //Creates an array of type Question to store the objects of the class Question
    var list = [Question]()
    
    init(){
        
        let newQuestionObject = Question(text: "Rio de Janeiro is the Brazil's Capital", correctAnswer: false)
